...
Dodano graficzne mierniki poziomu wejściowego i każdego wyjścia w zakładce Wyjścia karty. Skala −60…0 dBFS, szczyt próbek z okna około 100 ms. OUT pokazuje poziom po regulacji i mute, przed sterownikiem karty. Mierniki pozostają aktywne przy zamrożonej historii i gasną po Stop.
...
Instalacja: zamknij poprzednią wersję i uruchom **SMPTE-History-1.1.1.pkg**. Alternatywnie otwórz DMG i przeciągnij aplikację do Applications. Wymagany macOS 13+, Apple Silicon lub Intel. Pakiety nie mają podpisu Developer ID ani notaryzacji Apple.
